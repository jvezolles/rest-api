...
class UserUpdateE2ETest {
    ...
    void testUpdateUser() throws Exception {
        ...
        MvcResult result = mockMvc.perform(patch("/user")
    ...
    /**
     * Test fail if update user blank
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserBlank() throws Exception {
    ...
    /**
     * Test fail if update user not exist
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserNotExist() throws Exception {
    ...
    /**
     * Test fail if update user not adult
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserNotAdult() throws Exception {
    ...
    /**
     * Test fail if update user not french
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserNotFrench() throws Exception {
    ...
    /**
     * Test fail if update user with username missing
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserUsernameMissing() throws Exception {
    ...
    /**
     * Test fail if update user with username too long
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserUsernameTooLong() throws Exception {
    ...
    /**
     * Test fail if update user with birthdate missing
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserBirthdateMissing() throws Exception {
    ...
    /**
     * Test fail if update user with birthdate wrong format
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserBirthdateWrongFormat() throws Exception {
    ...
    /**
     * Test fail if update user with country missing
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserCountryMissing() throws Exception {
    ...
    /**
     * Test fail if update user with country too long
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserCountryTooLong() throws Exception {
    ...
    /**
     * Test fail if update user with phone too long
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserPhoneTooLong() throws Exception {
    ...
    /**
     * Test fail if update user with gender too long
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserGenderTooLong() throws Exception {
    ...
    /**
     * Test fail if update user with mail too long
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserMailTooLong() throws Exception {
    ...
    /**
     * Test fail if update user with mail wrong format
     *
     * @throws Exception if error occurs
     */
    @Test
    void testUpdateUserMailWrongFormat() throws Exception {
